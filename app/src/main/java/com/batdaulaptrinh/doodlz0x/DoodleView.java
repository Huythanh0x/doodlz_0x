...
// if there is already a path for lineID
    ...
    public void saveImage() {
        ...
        if (location != null) {
            ...
            message = Toast.makeText(getContext(), R.string.message_saved, Toast.LENGTH_SHORT);
        } else {
            // display a message indicating that there was an error saving
            message = Toast.makeText(getContext(), R.string.message_error_saving, Toast.LENGTH_SHORT);
        }
